...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Nutrime - Mental Health</title>
                  ...
                  <div class="nano">
                     <div class="content">
                        <div class="RemovePad" style="padding-right: 25px;">
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Mental Health</span></p>
                           <p>Mental health and nutrition are very closely linked as the human brain has high energy and nutrient needs. Nutritional imbalances and certain lifestyle choices can affect brain function, leading to mental health issues such as depression and anxiety.</p>
                           <p>Those suffering from Depression, Stress, Attention Deficit Disorder, Bi polar disorder and Schizophrenia can also benefit from Nutritional Therapy, although it should always work alongside other treatments recommended by your doctor.</p>
                           <p><strong>The Aim of the Mental Health Program is to:</strong></p>
                           <ul id="bullets">
                              <li>Identify and eliminate any nutritional deficiencies</li>
                              <li>Help support brain function</li>
                              <li>Balance your blood sugar levels to help stabilize your mood</li>
                              <li>Help you achieve a healthy weight</li>
                              <li>Reduce your intake of nutrients/substances which affect your mental health</li>
                           </ul>
                           <span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Food production and manufacturing techniques </span>
                           <div class="extraInfo"> What we are eating now is very different from that of our recent ancestors. Food production and manufacturing techniques, coupled with changing lifestyles and increasing access to processed foods, mean that our intake of fresh, seasonal, local produce is much lower, at the same time as our intake of fat, sugar, alcohol and additives is much higher. It has been estimated that the average person in the UK will eat more than 4 kilograms of additives every year.</div>
                           <div class="clear"></div>
                        </div>
                     </div>
                  </div>
