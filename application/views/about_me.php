      ...
      <div class="contents">
         <div class="row" style="overflow:visible;">
                  ...
                  <div class="nano">
                     <div class="content">
                        <div class="RemovePad" style="padding-right: 25px;">
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Tess Scott, BSc NT, mBANT, regCNHC</span></p>
                           <p>Nutrition is at the starting point of any human life right from the egg and sperm to old age.<br>
                              What goes into this complex machine called the body is vital to help ensure a healthy, long and fulfilled life.
                           </p>
                           <p>Every individual is different and genetics and lifestyle also plays its part. A good understanding of what is going on in your body and what can be done to improve it is at the heart of what excites ME!</p>
                           <p>During studying my Nutritional Degree I conceived, gave birth, breast-feed and weaned both my children. This lead me into the direction of specializing in fertility, pregnancy and child nutrition.  It’s an amazing area to work in and I feel very passionate and lucky to have the ability to help people during these stages with positive results.</p>
                           <p>NUTRIME Nutrition is all about maximizing your health during life stages to help achieve your personal goals. </p>
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Fully qualified nutritional therapist</span></p>
                           <p>I hold a BSc in Nutritional Therapy from the University of West London. The degree included detailed studies on areas such as anatomy and physiology, metabolic dysfunction of disease, pathophysiology of named conditions and biochemical functions of the body.</p>
                           <p>I hold a membership of British Association of Applied Nutrition and Nutritional Therapy (BANT), a professional body for Nutritional Therapists in the United Kingdom, as well being regulated in the Complementary and Natural Healthcare Council (CNHC). </p>
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">your next step</span></p>
                           <p>The best action you can take is to take control and become informed so contact NUTRIME.</p>
                           <div class="extraInfo">"The secret of health for both mind and body is not to mourn for the past, nor to worry about the future, but to live the present moment wisely and earnestly." — Buddha</div>
                           <div class="clear"></div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="grid_4 DropShadow" style="height:auto">
               <div class="padding30"> <img src="<?php echo base_url()?>assets/images/tess-scott.jpg" width="228" height="342"> </div>
            </div>
         </div>
      </div>
      <div class="footer">
         ...
         <div class="row">
            ...
            <div class="grid_4 centre"> <img src="<?php echo base_url()?>assets/images/footer-logo.png" width="288" height="142"></div>
         </div>
      </div>
