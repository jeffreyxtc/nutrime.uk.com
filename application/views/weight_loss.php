...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Nutrime - Weight Loss</title>
                  ...
                  <div class="nano">
                     <div class="content">
                        <div class="RemovePad" style="padding-right: 25px;">
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Weight Control</span></p>
                           <p><strong>Weight loss</strong> at times can feel like a never ending and ultimately losing battle.  With the abundance of processed foods, lacking in nutrients,and busy lifestyles which make planning and preparing healthy meals difficult, the weight loss process becomes even more challenging.  </p>
                           <p>The aim is to help you to identify your pitfalls and offer you tips and tricks to enable you to lose weight whilst enjoying all foods.</p>
                           <p>Some may find it difficult to gain weight and this can be achieved through correct protein, carbohydrate and fat intakes, but most importantly in the correct quantities.</p>
                           <p><strong>The aim of my Weight Loss Plan is to:</strong></p>
                           <ul id="bullets">
                              <li>Help you lose weight whilst enjoying all foods</li>
                              <li>Help you to identify your pitfalls and offer solutions, tips and tricks to help you overcome any obstacles</li>
                              <li>Offer detailed menu and recipe plans that include real, wholesome nutritious and above all tasty food!</li>
                              <li>Guide you towards eating the correct portion sizes</li>
                              <li>Provide moral support to help you achieve your goals</li>
                           </ul>
                           <p><strong>Weight gain</strong> - Some may find it difficult to gain weight and this can be achieved through correct protein, carbohydrate and fat intakes, but most importantly in the correct quantities.</p>
                           <p><strong>Individual:</strong></p>
                           <p>A Nutritional Weight loss programme will be tailor made to the individual’s specific needs. They will also provide the opportunity to consider:</p>
                           <ul id="bullets">
                              <li>Any core imbalances contributing to weight gain</li>
                              <li>Emotional factors that may be playing a part in this.</li>
                           </ul>
                           <p><strong>Small Groups:</strong></p>
                           <ul id="bullets">
                              <li>These can be families, friends or work colleagues, to help encourage group support during<br> the programme.</li>
                           </ul>
                           <div class="clear"></div>
                        </div>
                     </div>
