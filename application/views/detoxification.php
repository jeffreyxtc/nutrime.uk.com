...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Nutrime - Detoxification</title>
                  ...
                  <div class="nano">
                     <div class="content">
                        <div class="RemovePad" style="padding-right: 25px;">
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Detoxification</span></p>
                           <p>A polluted and stressful environment can overburden our body, resulting in a build up of toxins that compromise our health and appearance.
                           <p>
                           <p>Toxins are in our food, including over 4,000 additives used in commercial food production, Toxins in our drinking water, including residues from the industrial, agricultural and pharmaceutical industries, and toxins in our homes, with over 100,000 chemicals registered for commercial use in Europe, which find their way into our cosmetics, detergents and household products.</p>
                           <p>So it’s not surprising that from time to time our bodies feel congested and cry out for a much needed detox. Toxic overload causes many symptoms and in the longer term can slow down our body systems and functions, leading to exhaustion, premature ageing and degenerative disease.</p>
                           <p><strong>The NUTRI<i>ME</i> detox programme could help to experience the following:</strong></p>
                           <ul id="bullets">
                              <li>Greater vitality and energy</li>
                              <li>Improved digestion</li>
                              <li>Clear and glowing skin</li>
                              <li>Weight loss</li>
                              <li>Better immunity</li>
                              <li>Improved mood</li>
                           </ul>
                           <div class="extraInfo">
                              <strong>Detox diets may not be suitable for everyone, so we will assess if this process is suitable for you.</strong>
                           </div>
                           <div class="clear"></div>
                        </div>
                     </div>
