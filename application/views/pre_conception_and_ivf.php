...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Nutrime - Pre-conception and IVF</title>
                  ...
                  <div class="nano">
                     <div class="content">
                        <div class="RemovePad" style="padding-right: 25px;">
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Pre-conception and IVF</span></p>
                           <p>If you were going to climb up a mountain would you not prepare yourself for this journey? </p>
                           <p>You and your partner when deciding to conceive should also prepare yourselves for this journey. </p>
                           <p>Your eggs are as old as you are which is plain fact.  Yet the way in which you can nourish your eggs and the environment in which they mature can make a huge difference. By maximizing the right nutrition and avoiding some foods and ensuring your lifestyle does not hinder the process will only help to grow a healthy egg to maturity in a strong environment.</p>
                           <p><strong>The aim of my pre-conception plan is to help you improve your
                              chances of conceiving by:</strong>
                           </p>
                           <ul id="bullets">
                              <li>Addressing any nutritional deficiencies or overloading</li>
                              <li>Implementing anti-inflammatory strategies</li>
                              <li>Improving the health and quality of the ova, sperm and womb</li>
                           ...
                           <p>Each individual is unique so each nutritional programme is unique and I will help to guide and support you during this time. </p>
                           <p>Male nutrition and lifestyle is also just as important to this process so good nutrition and healthy living can be just as important to ensure healthy and strong sperm.</p>
                           <p>Acupuncture coupled with nutrition can be a powerful natural force when trying to conceive.</p>
                           <div class="clear"></div>
                        </div>
                     </div>
                  </div>
