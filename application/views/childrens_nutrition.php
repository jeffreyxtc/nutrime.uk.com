...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Nutrime - Childrens Nutrition</title>
                  ...
                  <div class="nano">
                     <div class="">
                        <div class="RemovePad" style="padding-right: 25px;">
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">Children's Nutrition</span></p>
                           <p>What you feed your children is of great importance, especially during early years, when they are growing and developing at a rapid pace.  Correct nutrition will ensure they are getting all the nutrients they need to support their body’s needs during this crucial period of development.</p>
                           <p>Child obesity is on the rise and can greatly affect your child’s health, increasing the risk of diabetes, certain cancers and cardiovascular disease. Dealing with a child’s weight gain can be distressing for parents, as they may not know how to tackle the issue. Ignoring the situation can create further problems.</p>
                           <p>Dealing with children’s weight loss is a sensitive subject, and the plan is to work with the children and parents together, focusing on living healthier, enjoying sports and feeling happier. Including the whole family here ensures the child does not feel isolated in this journey.</p>
                           <p><strong>The aim of my Children’s Health programme is to:</strong></p>
                           <ul id="bullets">
                              <li>Ensure they are getting the correct nutrients for their growing needs</li>
                              <li>Address any food intolerances</li>
                              <li>Address any nutrient deficiencies</li>
                              <li>Ensure brain development</li>
                              <li>Boost concentration levels</li>
                           </ul>
                           <p>Beyond a 'healthy balanced diet' there are specific nutritional factors that are of importance for the different developmental stages of children, from birth to weaning, toddlers to the adolescent growth spurt, thus poor nutrition can affect brain development, the building of strong bones, muscles and teeth, to name a few.</p>
                           Small group discussions regarding weaning or children’s nutrition requirements are available.
                           <div class="clear"></div>
                        </div>
                     </div>
                  </div>
