...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Nutrime - What is Nutritional Therapy?</title>
   ...
   <body>
      <?php echo $mobileNav; ?>
      <div id="background"> <img src="<?php echo base_url('assets/images/'.$full_bg); ?>" class="stretch" alt="" /> </div>
      <div class="backdrop">
      </div>
                  ...
                  <div class="nano">
                     <div class="content">
                        <div style="padding-right: 20px;">
                           <p><span class="header">NUTRI<i>ME</i> -</span> <span class="headerGreen">What is Nutritional Therapy?</span></p>
                           <p style="margin-top: 3px;">Nutritional Therapy is the application of nutrition science in the promotion of health, peak performance and individual care. Nutritional therapy practitioners use a wide range of tools to assess and identify potential nutritional imbalances and understand how these may contribute to an individual's symptoms and health concerns. </p>
                           <p>This approach allows them to work with individuals to address nutritional balance and help support the body towards maintaining health. Nutritional therapy is recognised as a complementary medicine and is relevant for individuals with chronic conditions, as well as those looking for support to enhance their health and wellbeing.</p>
                           <p>Practitioners consider each individual to be unique and recommend <a href="individual-programs">personalised nutrition</a> and lifestyle programmes rather than a 'one size fits all' approach.</p>
                           <div class="extraInfo">
